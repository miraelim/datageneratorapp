...
int main(int argc, char **argv)
{
    ...
    FILE *fp1, *tempdatapoint;
    char weatherdata[1024];
    struct tm *t;
    time_t timer;

    fp1 =fopen("weatherdata.txt","r");
    tempdatapoint =fopen("tempdatapoint.txt","w+");
	...
	json_object_object_add(schemaobj, "name", json_object_new_string("weather_temperature"));
