...
int main(int argc, char **argv)
{
	...
	json_object *myobj, *headerobj, *dataobj, *schemaobj, *effectimeobj, *bodyobj, *tempobj, *temperature1obj, *temp_maxobj, *temp_minobj, *humidity1obj, *pressure1obj, *sunrise1obj, *sunset1obj, *wind1obj, *windspeed1obj, *winddirec1obj, *clouds1obj, *visibility1obj, *precipitation1obj, *weather1obj;
	...
	//header 영역
	json_object_object_add(headerobj, "id", json_object_new_int(system("uuid")));
	...
	json_object_object_add(headerobj, "user_id", json_object_new_int(system("hostid")));
